...
см. reader/turkey_bot/gib/fine_parser.py) на русский через OpenAI
Structured Outputs.
...
принцип изоляции, что и у остального reader/turkey_bot/ (standalone-бот,
...
Вызывается ИСКЛЮЧИТЕЛЬНО из reader/turkey_bot/conversation.py, ПОСЛЕ того
как reader/turkey_bot/gib/fine_parser.py уже структурно распарсил BORCLAR —
