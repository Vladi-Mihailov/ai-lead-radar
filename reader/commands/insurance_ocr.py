...
# задачи (Собственник, Водитель, Страхователь, Марка, Модель, VIN, ...) —
# три РАЗНЫЕ роли ФИО, каждая читается из своего атрибута НЕЗАВИСИМО, без
# какого-либо fallback одной роли на другую (см. reader/ocr/models.py про
# разные источники-документы каждой роли).
_REPLY_FIELDS = (
