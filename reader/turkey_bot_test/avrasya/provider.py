...
reader/turkey_bot_test/gib/provider.py/reader/fines/police_ge_provider.py:
...
from reader.turkey_bot_test.avrasya.parser import parse_submit_response
from reader.turkey_bot_test.avrasya.session import AvrasyaSession
