...
Полностью независимо от reader/turkey_bot_test/gib/* (см. задачу: "Avrasya
...
from reader.turkey_bot_test.avrasya.models import AvrasyaCaptchaChallenge
...
class AvrasyaTransportError(Exception):
    ...
    no_debt/has_debt/unexpected, см. reader/turkey_bot_test/avrasya/models.py)
...
class AvrasyaSession:
    ...
    async def submit(self, *, plate: str, captcha_code: str) -> tuple[int, object]:
        ...
        ИСКЛЮЧИТЕЛЬНО reader/turkey_bot_test/avrasya/parser.py (см. design
