...
вызывать reader/turkey_bot_test/conversation.py — сам ConversationController
никогда не обращается к GibSession напрямую.
"""

from reader.turkey_bot_test.gib.models import CaptchaChallenge, GibSubmitOutcome
from reader.turkey_bot_test.gib.parser import parse_submit_response
