...
# Намеренно ГРУБАЯ классификация (см. reader/turkey_bot_test/gib/parser.py) —
...
class GibSubmitOutcome:
    ...
    kind:
      ...
      - "has_debt"    — либо "data" непуст (изначальное, недоказанное
        ...
        GibFineRecord ниже и reader/turkey_bot_test/gib/fine_parser.py) — только
...
class GibFineRecord:
    ...
    reader/turkey_bot_test/gib/translation.py::TurkeyFineTranslationService),
