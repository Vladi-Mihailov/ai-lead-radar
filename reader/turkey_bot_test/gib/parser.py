...
GibFineRecord (см. reader/turkey_bot_test/gib/fine_parser.py про полный аудит
...
from reader.turkey_bot_test.gib.fine_parser import parse_fine_records
from reader.turkey_bot_test.gib.models import GibMessage, GibSubmitOutcome
