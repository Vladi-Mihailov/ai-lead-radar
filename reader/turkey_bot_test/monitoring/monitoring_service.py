...
(reader/turkey_bot_test/conversation.py) — разница только в инициаторе
...
from reader.turkey_bot_test.monitoring.change_detector import detect_changes
from reader.turkey_bot_test.monitoring.notification_texts import (
...
from reader.turkey_bot_test.unified.models import UnifiedCheckResult
