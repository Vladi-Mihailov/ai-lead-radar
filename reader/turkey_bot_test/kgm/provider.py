...
(разбор) — см. reader/turkey_bot_test/avrasya/provider.py::AvrasyaProvider,
...
from reader.turkey_bot_test.kgm.parser import parse_submit_response
from reader.turkey_bot_test.kgm.session import KgmSession
