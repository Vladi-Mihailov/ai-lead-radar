"""
Тесты Pipeline — в частности новое побочное обновление UserRepository.keywords
по совпавшим сценариям (см. reader/users/keyword_matches.py). Проверяем, что
существующее поведение (lead detection/forwarding в sinks) не меняется, а
обновление keywords — чистый side-effect поверх него.
"""
